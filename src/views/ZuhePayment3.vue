...
<script>
  ...
  import {formatCurrency, digitUppercase, numMulti} from '../unilt'
  ...
  export default {
    ...
    computed: {
      ...
      firstPay() {
        ...
        console.log(this.cartMoney - this.splitAmount);
      ...
      comCost() {
        console.log("分期金额：", Math.ceil(numMulti((this.rate - this.bankMark), this.money)) / 100 + 250);
        return Math.ceil(numMulti((this.rate - this.bankMark), this.money)) / 100 + 250
      },
      monthRepay() {
